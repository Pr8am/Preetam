...
\author{Sai Preetam Umesh Sasankota\\EE23BTECH11221}
\date{}
...
\begin{align}
    \Omega_{Ls1} &= \frac{\Omega_{s1}^2 - \Omega_0^2}{B\Omega_{s1}} = -1.54\\
    \Omega_{Ls2} &= \frac{\Omega_{s2}^2 - \Omega_0^2}{B\Omega_{s2}} = 1.47
\end{align}
And we choose the minimum of these two stopband edges
\begin{align}
    \Omega_{Ls} = \mbox{min}(\vert \Omega_{Ls_1}\vert,\vert \Omega_{Ls_2}\vert) = 1.47
\end{align}
...
we get $N\geq 4$ and $0.31 \leq \epsilon \leq 0.62$\\
\newpage
The below code plots \eqref{eq:mag_freq_response} for different values of $\epsilon$ .
\begin{lstlisting}
https://github.com/Pr8am/Preetam/blob/main/Filter%20design/codes/plot1.py
\end{lstlisting}
\begin{figure}[H]
\centering
...
\begin{lstlisting}
https://github.com/Pr8am/Preetam/blob/main/Filter%20design/codes/sk_gen.c
\end{lstlisting}
...
\begin{lstlisting}
https://github.com/Pr8am/Preetam/blob/main/Filter%20design/codes/pole_zero_plt.py
\end{lstlisting}
\begin{figure}[H]
\centering
...
Plot fot Figure 3
\begin{lstlisting}
https://github.com/Pr8am/Preetam/blob/main/Filter%20design/codes/plot2.py
\end{lstlisting}
...
\begin{lstlisting}
https://github.com/Pr8am/Preetam/blob/main/Filter%20design/codes/plot3.py
\end{lstlisting}
\subsection{The Digital Filter}
