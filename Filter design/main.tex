...
\author{Abhey Garg\\EE23BTECH11202}
\date{}
...
\begin{lstlisting}
https://github.com/Abhey-05/Abhey/blob/main/Filter%20design/codes/plot1.py
\end{lstlisting}
\begin{figure}[H]
\centering
...
\begin{lstlisting}
https://github.com/Abhey-05/Abhey/blob/main/Filter%20design/codes/sk_gen.c
\end{lstlisting}
...
\begin{lstlisting}
https://github.com/Abhey-05/Abhey/blob/main/Filter%20design/codes/pole_zero_plt.py
\end{lstlisting}
\begin{figure}[H]
\centering
...
Plot fot Figure 3
\begin{lstlisting}
https://github.com/Abhey-05/Abhey/blob/main/Filter%20design/codes/plot2.py
\end{lstlisting}
...
\begin{lstlisting}
https://github.com/Abhey-05/Abhey/blob/main/Filter%20design/codes/plot3.py
\end{lstlisting}
\subsection{The Digital Filter}
